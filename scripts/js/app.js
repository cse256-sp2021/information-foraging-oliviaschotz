...
var TopBanner = /** @class */ (function () {
    ...
    TopBanner.setup = function () {
        ...
        setTimeout(TopBanner.doDisplayChange, 3000);
    };
    TopBanner.showing = true;
    return TopBanner;
}());
...
var enlargePhotos_1 = require("./enlargePhotos");
...
},{"../core/utils/html_loader":18,"./accordion":23,"./do-something":24,"./enlargePhotos":26,"./html-imports":27,"./slideshow":30,"./sticky":31}],26:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
function enlarge(img, i) {
    var images = document.getElementsByTagName("img");
    console.log(images);
    for (var i_1 = 0; i_1 < images.length; ++i_1) {
        images[i_1].addEventListener("click", enlargeImg);
    }
}
